...
namespace iat {
    ...
    template<>
    std::complex<double> Matrix<std::complex<double>>::maxElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<long double> Matrix<std::complex<long double>>::maxElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<float>Matrix<std::complex<float>>::maxElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<long int> Matrix<std::complex<long int>>::maxElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<int> Matrix<std::complex<int>>::maxElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<short int> Matrix<std::complex<short int>>::maxElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }
    ...
    template<>
    std::complex<long double> Matrix<std::complex<long double>>::minElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<float> Matrix<std::complex<float>>::minElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<long int> Matrix<std::complex<long int>>::minElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<int> Matrix<std::complex<int>>::minElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }

    template<>
    std::complex<short int> Matrix<std::complex<short int>>::minElement() const
    {
        throw ErrorMatrix(MatrixErrorCode::COMPLEX_NUMBER_COMPARISON);
    }
